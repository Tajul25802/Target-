#DECODE BY T . I . R CYBER RABBI 
#DECODE BY Tajul Islam Rabbi 
#OWNER : CYBER RABBI 
...
def banner():
  os.system("clear")
  print("\n\n")
  os.system("figlet -f slant CYBER RABBI |lolcat")
  print(lines)
  print("""
   ...
   Facebook     : \033[1;32mTR TACKNOLAGY 360\033[1;37m
  """)
  print(lines)
  upass=input("\n   [•] Enter Tool's Password: ")
  if upass=="CYBER-RABBI" or upass == "RABBI" or upass == "team Tr360" or upass == "Team Rabbi":
